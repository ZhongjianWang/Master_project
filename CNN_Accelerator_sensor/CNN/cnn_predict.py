...
realdata = read_data('WISDM_ar_v1.1/WISDM_ar_v1.1_900test.txt')
...
print(result_cnn)
#print("Downstairs:{:.2f}, Jogging:{:.2f}, Sitting:{:.2f}, Standing:{:.2f}, Upstrairs:{:.2f}, Walking:{:.2f}".format(result_cnn[0][0], result_cnn[0][1], result_cnn[0][2], result_cnn[0][3], result_cnn[0][4] ,result_cnn[0][5])) 
session.close()
